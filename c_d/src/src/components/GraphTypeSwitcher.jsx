...
const GraphTypeSwitcher = ({
  ...
  // console.log("🚀 ~ file: GraphTypeSwitcher.jsx:22 ~ type:", type)
  // console.log("🚀 ~ file: GraphTypeSwitcher.jsx:22 ~ dataKey:", dataKey)
  // console.log("🚀 ~ file: GraphTypeSwitcher.jsx:22 ~ data:", data)
  // console.log("🚀 ~ file: GraphTypeSwitcher.jsx:22 ~ XaxisName:", XaxisName)
  // console.log(data)
