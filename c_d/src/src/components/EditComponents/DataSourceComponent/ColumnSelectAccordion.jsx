...
const ColumnSelectAccordion = ({ panelID, data }) => {
  ...
  // console.log('tttttt', data.dataTable)
          ...
          {data.columnSelect.map((colKeys, colIdx) => {
            ...
            return (
              <Stack direction='row' spacing={1} key={colIdx}>
                ...
                {/* first layer selection cannot be deleted, can only delete by delete column */}
                <Select
                ...
                {colKeys.length > 1 ? (
                  ...
                  colKeys.slice(1,).map((key, keyIdx) => {
                    ...
                    if (!Array.isArray(selectKeys) && typeof selectKeys === 'object') {
                ...
                {!Array.isArray(selectValue) && typeof selectValue === 'object' ? (
                  <IconButton
                    color='primary'
                    size='small'
                    onClick={() => {
                    ...
                    // disabled={!(!Array.isArray(selectValue) && typeof selectValue === 'object')}
                  >
