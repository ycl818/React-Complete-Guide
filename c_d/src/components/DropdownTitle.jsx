...
import { setAreaSetting, setBarSetting, setChartSetting, setChartType, setComposeSetting, setLineSetting, setPieSetting, setXKeyIndex, setYKeyIndex } from "../store";
...
const DropdownTitle = ({ title, panelID }) => {
  ...
  const handleEditClick = () => {
    if (chartType !== null) {
      ...
      dispatch(setXKeyIndex(chartXkey))
      dispatch(setYKeyIndex(chartYkey))
    }
  }
